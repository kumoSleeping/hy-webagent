    ...
    endpoints: [
      ...
      },
      {
        ...
        body: {
          ...
          modelTemplateId: "optional: deepseek-flash | null (default deepseek-flash)",
      ...
      },
      {
        ...
        body: { role: "admin | user", budgetUsd: "number | null", displayName: "string", modelTemplateId: "deepseek-flash | null" },
        example: {
      ...
      },
      {
        ...
        auth: "admin",
        description: "List model access templates (deepseek-flash, …)",
      },
      {
        method: "GET",
    ...
    cli: {
      ...
      commands: [
        ...
        { command: "users list", description: "List users (local JSON or remote API)", example: "npm run admin -- users list" },
        {
          ...
          example: "npm run admin -- users create --name Alice --username alice --model-template deepseek-flash",
        },
        {
